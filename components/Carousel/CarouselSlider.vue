<template>
  <div>
    ...
    >
      <Slide v-for="(item, index) in data" :key="index" class="relative m-2">
        <NuxtLink
          to="/product-view"
        ...
        >
          ...
          <div class="border-2 border-[#F3F3F3] rounded-t-[10px] relative">
            ...
            />
            <span
              class="border-2 bg-[#FCFCFC] border-[#F3F3F3] w-[40px] h-[40px] block absolute top-[10px] right-[10px] rounded-full flex justify-center items-center pointer"
            >
              <svg
                width="19"
                height="17"
