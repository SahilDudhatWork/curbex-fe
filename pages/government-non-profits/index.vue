  ...
  <div>
    <div class="mx-6">
        ...
        <div class="container mx-auto mb-[3rem] md:mb-[6rem]">
            <div class="pt-[2.25rem]">
                <img src="/Images/government-non-profits/hero.webp" alt="" class="rounded-[20px] h-[206px] md:h-[461px] object-cover w-full">
            </div>
        </div>
    </div>
    <!------------------------------------------------->
    ...
    <!--------------------- Government & Non-Profit ---------------------->
        <div class="container mx-auto">
            <div class="flex justify-center">
                <h1 class="text-[15px] sm:text-[30px] lg:text-[38px] text-white font-Montserrat-Bold bg-[#121212] py-[6px] px-8 rounded-full mt-[-51px] mb-[15px] sm:mt-[-63px] sm:mb-[8px] lg:mt-[-65px] lg:mb-[3px]">Government & Non-Profit</h1>
            </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="flex justify-center mt-10">
                <p class="max-w-screen-xl mx-auto text-[#131313] font-normal text-[16px] md:text-[21px] text-left lg:text-center pb-5 leading-[31px]">At Curbex, We understand the importance of getting your message across – whether it's promoting community programs, public services, or local events. Our high-impact mini billboards are trusted by municipalities and non-profits across Canada for their effectiveness and affordability. With vibrant, durable signage, we help public organizations make announcements, spread awareness, and engage residents – all without exceeding budget constraints.</p>
            </div>
    
            <div>
                <div class="mt-10 lg:grid md:grid grid-cols-2 gap-8">
                    <img src="/Images/government-non-profits/residents1.webp" alt="" class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]">
                    <img src="/Images/government-non-profits/residents2.webp" alt="" class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]">
                </div>
            </div>  
        </div>
        <!------------------------------------------------->
        ...
        <div class="mt-8 md:mt-16">
            <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                <div class="flex items-center gap-4 pb-5">
                    ...
                    <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]">Professional Signage at a Community-Friendly Price</p>
                </div>
                <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    Our signage solutions provide the same professional quality trusted by large organizations but tailored to the needs of municipalities and non-profits. We know that budgets are tight, so we offer affordable, high-impact advertising tools that ensure your public messages reach every corner of your community. <span class="font-semibold"> Make an impression without stretching your resources</span>
                </div>
            </div>
        </div>
        <div class="mt-8 md:mt-8">
            <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                <div class="flex items-center gap-4 pb-5">
                    ...
                    <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]">Promote Events and Programs with High Visibility</p>
                </div>
                <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    Whether you're promoting recreational programs, city-wide events, or public service announcements, our signage solutions provide the visibility needed to make sure your message is seen. From busy intersections to community centers, Curbex signs are designed to capture attention wherever they're placed.<span class="font-semibold">  Engage the community with creative, modern signage designed to make an impact</span>
                </div>
            </div>
        </div>
        <div class="mt-8 md:mt-8">
            <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                <div class="flex items-center gap-4 pb-5">
                    ...
                    <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]">Simple, Hassle-Free Sign Management</p>
                </div>
                <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    Managing public communication campaigns can be complex. That's why we make signage easy to design, order, and deploy. With Curbex, your team can create and manage signs with minimal effort. Our process is quick and straightforward, from design to installation, saving you time and resources.<span class="font-semibold">No more complicated logistics – just effective signage, ready when you need it.</span>
                </div>
            </div>
        </div>
        <div class="mt-8 md:mt-8">
            <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                <div class="flex items-center gap-4 pb-5">
                    ...
                    <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]">Effective Communication with Measurable Results</p>
                </div>
                <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    Curbex signage offers more than just visibility – it drives action. With bold, eye-catching designs, your messages are more likely to engage the community, increasing participation and awareness. Whether you're promoting health initiatives, cultural events, or new services, Curbex signs deliver results.
                </div>
            </div>
        </div>
        <div class="mt-8 md:mt-8">
        ...
        <div class="mt-20">
            <div class="flex">
                <p class="bg-[#FFA900] text-[#121212] font-semibold text-[16px] sm:text-[18px] md:text-[24px] rounded-[17px] md:rounded-full py-[7px] px-6">
                    Use Cases for Curbex in Municipalities & Non-Profits
                </p>
            </div>
            <div class="mt-[1.5rem] md:mt-10">
                <p class="text-[#131313] font-normal text-[16px] md:text-[18px] lg:text-[21px] leading-[31px]">From large cities to small towns, public organizations across Canada trust Curbex to deliver professional, affordable signage that engages their communities. Whether you're a municipality promoting public services or a non-profit running a campaign, Curbex signs provide the tools you need to make your message stand out.</p>
                <p class="text-[#131313] font-normal text-[16px] md:text-[18px] lg:text-[21px] lg:pb-[5rem] md::pb-[2rem] sm::pb-[5rem] leading-[31px]">Curbex signage connects your community with the programs and events that matter most.</p>
            </div>
        </div>
    </div>
    <!------------------------ Why Choose Curbex? ------------------------->
    <div class="mt-8 md:mt-[3rem] lg:mt-16 px-6 lg:bg-[#FCFCFC] lg:border-t-2 lg:border-b-2 border-[#f3f3f3] p-8 pb-0">
        <div class="mt-0 lg:mt-[-59px] container mx-auto">
            <div class="flex md:mb-[2rem] lg:mb-[0rem]">
            ...
            <div class="flex items-end lg:items-center relative">
                ...
                <div class="md:w-[70%] lg:w-[40%] hidden md:block">
                    <img src="/Images/government-non-profits/slap.png" alt="" class="max-w-[300px] lg:max-w-[450px] md:w-full md:max-w-[94%] ml-auto mt-[-6rem]">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-8 md:mt-16 px-6 bg-[#FCFCFC] border-t-2 border-b-2 border-[#f3f3f3] p-8 pb-[3rem] md:pb-[4rem] mb-[4rem]">
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap justify-between mt-8 md:mt-10 lg:mt-16">
                <div class="relative group border-[2px] border-[#F3F3F3] hover:border-[#4f8dff] bg-[#FFFFFF] rounded-[21px] p-4 flex w-[100%] lg:w-[48%] m-2 ml-0">
                    <div class="hidden group-hover:block h-[25px] w-[25px] rounded-full bg-[#4f8dff] absolute left-[-13px] top-1/2 transform -translate-y-1/2"></div>
                    <img src="/Images/government-non-profits/R1.png" alt="" class="md:w-[151px] md:h-[148px] w-[45%] rounded-[15px] object-cover mr-5">
                    <div>
                        <p class="text-[#000000] text-[12px] md:text-[18px] font-bold max-w-[21rem] font-Montserrat-Medium">Diversifying Blood Donations to Save Lives</p>
                        <p class="text-[10px] md:text-[12px] text-[#000000] max-w-[33rem]  my-[10px] md:my-[13px]">Increasing diverse blood and stem cell donations is crucial to saving lives and improving the quality of care for patients with diseases like sickle cell anemia.</p>
                        <a href="#" class="text-[10px] md:text-[12px] underline block group-hover:text-[#4f8dff]">Read More</a>
                    </div>
                </div>
                <div class="relative group border-[2px] border-[#F3F3F3] hover:border-[#4f8dff] bg-[#FFFFFF] rounded-[21px] p-4 flex w-[100%] lg:w-[48%] m-2 mr-0">
                    <div class="hidden group-hover:block h-[25px] w-[25px] rounded-full bg-[#4f8dff] absolute left-[-13px] top-1/2 transform -translate-y-1/2"></div>
                    <img src="/Images/government-non-profits/R2.png" alt="" class="md:w-[151px] md:h-[148px] w-[45%] rounded-[15px] object-cover mr-5">
                    <div>
                        <p class="text-[#000000] text-[12px] md:text-[18px] font-bold max-w-[21rem] font-Montserrat-Medium">Barrie's New Garbage Collection Schedule Starts on May</p>
                        <p class="text-[10px] md:text-[12px] text-[#000000] max-w-[33rem]  my-[10px] md:my-[13px]">Emterra Environmental takes over Barrie's waste collection, bringing changes to garbage, organics, and recycling services starting May 1.</p>
                        <a href="#" class="text-[10px] md:text-[12px] underline block group-hover:text-[#4f8dff]">Read More</a>
                    </div>
                </div>
                <div class="relative group border-[2px] border-[#F3F3F3] hover:border-[#4f8dff] bg-[#FFFFFF] rounded-[21px] p-4 flex w-[100%] lg:w-[48%] m-2 ml-0">
                    <div class="hidden group-hover:block h-[25px] w-[25px] rounded-full bg-[#4f8dff] absolute left-[-13px] top-1/2 transform -translate-y-1/2"></div>
                    <img src="/Images/government-non-profits/R3.png" alt="" class="md:w-[151px] md:h-[148px] w-[45%] rounded-[15px] object-cover mr-5">
                    <div>
                        <p class="text-[#000000] text-[12px] md:text-[18px] font-bold max-w-[21rem] font-Montserrat-Medium">Town Increases Parking Fines in Waterfront Park Buffer Zone</p>
                        <p class="text-[10px] md:text-[12px] text-[#000000] max-w-[33rem]  my-[10px] md:my-[13px]">The Town of Georgina has raised fines for illegal parking and stopping within the Waterfront Park Buffer Zone to address safety concerns caused by summer visitors.</p>
                        <a href="#" class="text-[10px] md:text-[12px] underline block group-hover:text-[#4f8dff]">Read More</a>
                    </div>
                </div>
                <div class="relative group border-[2px] border-[#F3F3F3] hover:border-[#4f8dff] bg-[#FFFFFF] rounded-[21px] p-4 flex w-[100%] lg:w-[48%] m-2 mr-0">
                    <div class="hidden group-hover:block h-[25px] w-[25px] rounded-full bg-[#4f8dff] absolute left-[-13px] top-1/2 transform -translate-y-1/2"></div>
                    <img src="/Images/government-non-profits/R4.png" alt="" class="md:w-[151px] md:h-[148px] w-[45%] rounded-[15px] object-cover mr-5">
                    <div>
                        <p class="text-[#000000] text-[12px] md:text-[18px] font-bold max-w-[21rem] font-Montserrat-Medium">Calgary Urges Residents to Keep Trash Indoors to Protect Bears</p>
                        <p class="text-[10px] md:text-[12px] text-[#000000] max-w-[33rem]  my-[10px] md:my-[13px]">Discovery Ridge residents are being asked to keep garbage carts inside overnight to prevent attracting bears and reduce safety risks, following last year's bear-related incidents.</p>
                        <a href="#" class="text-[10px] md:text-[12px] underline block group-hover:text-[#4f8dff]">Read More</a>
                    </div>
                </div>
            </div>
