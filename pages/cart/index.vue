<template>
  <div>
    ...
    <div
      class="container mx-auto px-6 lg:px-0 flex justify-between flex-wrap lg:flex-nowrap"
      v-if="productsWithTotalPrice && productsWithTotalPrice.length"
    >
      <div class="w-full lg:w-[60%]">
        <div v-for="(item, index) in productsWithTotalPrice" :key="index">
          <div
            class="bg-[#FCFCFC] border border-[#F5F5F5] rounded-[25px] p-[15px] flex items-start mb-5 flex-wrap md:flex-nowrap"
          >
            <div
              class="border-2 border-[#F3F3F3] rounded-[20px] relative max-w-[100%] md:max-w-[250px] mr-0 mb-5 md:mb-0 md:mr-5"
            >
              <img
                :src="
              ...
              />
              <span
                @click.stop="toggleFavorite(item.product)"
                class="cursor-pointer border-2 bg-[#FCFCFC] border-[#F3F3F3] w-[40px] h-[40px] block absolute top-[10px] right-[10px] rounded-full flex justify-center items-center pointer scale-75 lg:scale-100"
              >
                <svg
                  width="19"
                  height="17"
            ...
            <div class="w-full flex flex-col justify-between md:min-h-[248px]">
              <div>
                <div class="flex items-center justify-between">
                  <p
                    class="text-[16px] md:text-[18px] text-[#121212] font-Montserrat-Medium font-bold"
                  >
                    {{ item?.product?.name }}
                  </p>
                  <p @click.stop="removeItem(item)" class="cursor-pointer">
                    <svg
                      width="37"
                      height="36"
                      viewBox="0 0 37 36"
                ...
                <div class="flex justify-between items-center">
                  <p class="flex p-[2px_6px] text-[12px] md:text-[14px] w-fit">
                    <span class="mr-2">
                      ...
                      >
                        <path
                          d="M4.075 7C4.075 5.11196 5.61199 3.575 7.5 3.575C9.38801 3.575 10.925 5.11196 10.925 7C10.925 8.88804 9.38801 10.425 7.5 10.425C5.61199 10.425 4.075 8.88804 4.075 7Z"
                          stroke="#121212"
                          stroke-width="1.15"
                        />
                        <path
          ...
          >
            <p class="text-[#FFFFFF]">
              You <span class="text-[#FFA900]">Hired a Designer</span> for this
              product
            </p>
            <p class="cursor-pointer">
              <span
                @click="toggleTab(index)"
                v-if="productHireDesignerIndex != index"
                class="underline decoration-solid decoration-[#FFA900] md:no-underline text-[#FFA900]"
                >View Details</span
              >
              <span
                @click="toggleTab(-1)"
                v-else
                class="underline decoration-solid decoration-[#C3C3C3] md:no-underline text-[#C3C3C3]"
                >Hide Details</span
              >
            </p>
          </div>
          ...
          >
            <p class="text-[#FFFFFF]">
              You <span class="text-[#FFA900]">Uploaded your Artwork </span> for
              this product
            </p>
            <p class="cursor-pointer">
              <span
                @click="toggleisArtWorkTab(index)"
                v-if="productArtworkIndex != index"
                class="underline decoration-solid decoration-[#FFA900] md:no-underline text-[#FFA900]"
                >View Details</span
              >
              <span
                @click="toggleisArtWorkTab(-1)"
                v-else
                class="underline decoration-solid decoration-[#C3C3C3] md:no-underline text-[#C3C3C3]"
                >Hide Details</span
              >
          ...
          <div
            v-if="productHireDesignerIndex == index"
            class="p-[60px_20px_12px] border border-[#F5F5F5] bg-[#FCFCFC] rounded-[25px] mt-[-50px] mb-5"
          >
            <p class="text-[#121212] text-[12px] md:text-[14px] my-4 mb-2">
              Instructions
            </p>
            <textarea
  ...
  Design a clean and eye-catching physical banner that highlights the key message with bold typography, vibrant visuals, and a clear call-to-action, ensuring high visibility from a distance.</textarea
            ...
            <div class="flex items-center py-2">
              <input
                type="url"
                class="border border-[#F5F5F5] bg-[#FFFFFF] rounded-[18px] w-full p-[7px_15px] text-[12px] mr-4"
                rows="4"
                placeholder="https://"
              />
              <span>
          ...
          <div
            v-if="productArtworkIndex == index"
            class="p-[30px_20px_12px] border border-[#F5F5F5] bg-[#FCFCFC] rounded-[25px] mt-[-50px] mb-5"
          >
            <p class="my-4 text-[#121212] text-[12px] md:text-[14px] my-4">
              Uploaded Artworks
            </p>
...
Design a clean and eye-catching physical banner that highlights the key message with bold typography, vibrant visuals, and a clear call-to-action, ensuring high visibility from a distance.</textarea
        ...
        >
          ...
          >
            ...
            />
            <span
              class="border-2 bg-[#FCFCFC] border-[#F3F3F3] w-[40px] h-[40px] block absolute top-[10px] right-[10px] rounded-full flex justify-center items-center pointer scale-75 lg:scale-100"
            >
              <svg
                width="19"
                height="17"
          ...
          <div class="w-full flex flex-col justify-between md:min-h-[248px]">
            <div>
              ...
              <p
                class="bg-[#FFEBC3] rounded-[5px] p-[2px_6px] text-[12px] md:text-[14px] w-fit mb-3"
              >
                Retail
              </p>
            </div>
...
Design a clean and eye-catching physical banner that highlights the key message with bold typography, vibrant visuals, and a clear call-to-action, ensuring high visibility from a distance.</textarea
      ...
      <div class="w-full lg:w-[35%]">
        ...
        >
          <p
            class="text-[14px] md:text-[18px] text-[#121212] font-Montserrat-Medium pb-[1.7rem]"
          >
            Order Summary
          </p>
          ...
          <input
            type="text"
            placeholder="Code"
            class="text-[12px] md:text-[14px] bg-[#FFFFFF] border border-[#C3C3C3] rounded-[8px] w-full p-[17px] mb-[1.5rem]"
          />
        ...
        <div
          class="bg-[#FCFCFC] border border-[#F5F5F5] rounded-[25px] p-[25px] md:p-[35px] mb-5 flex justify-between items-start"
        >
          <img
            src="/Images/Product/vanIcon.png"
            alt=""
            class="w-[40px] h-auto mr-[20px]"
          />
          <div>
            <p
              class="text-[12px] md:text-[18px] font-Montserrat-Medium pb-[10px]"
            >
              We deliver, setup, then pick up
            </p>
            <p class="text-[12px] md:text-[16px] md:pr-[40px]">
              Our expert installers are thoroughly instructed by your account
              manager on where and how your sign needs to be installed.
            </p>
          </div>
        </div>
      </div>
    ...
    <div
      class="mt-10 md:mt-[2.5rem] lg:mt-[2.5rem] container mx-auto px-6 lg:px-0 mb-[3rem]"
    >
      <p
...
export default {
  ...
  methods: {
    ...
    async toggleFavorite(product) {
      try {
        await this.toggleFavoriteProduct({ id: product.id });
        // this.$toast.open({
