<template>
    <div class="text-center my-[8rem] max-w-[320px] w-[90%] mx-auto bg-white rounded-[20px] p-8 border border-[#F5F5F5]">
        <div class="mb-4">
        ...
        <h3 class="text-[16px] font-medium text-gray-900 mb-4">Email Verification</h3>
        <p class="text-[14px] text-gray-500 mb-6">Your email was verified. You can continue using the application.</p>
    </div>
</template>
<script>
export default {
