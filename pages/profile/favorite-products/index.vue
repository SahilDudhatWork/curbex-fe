<template>
    <div>
        <div class="mx-auto md:p-6">
            <h1 class="text-[18px] md:text-[20px] font-semibold mb-3 md:pt-[1rem]">Favorite products</h1>
        </div>
        <div class="max-w-5xl grid grid-cols-2 lg:grid-cols-3 gap-3 md:px-6">
