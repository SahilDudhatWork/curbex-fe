<template>
  <div class="flex-1">
    <div class="max-w-3xl md:p-8">
        ...
        <div class="">
          <div class="relative mb-6">
            <img
              ...
              alt="Profile Picture"
              class="w-[91px] h-[91px] rounded-full object-cover"
            />
          </div>
          <div class="flex gap-4">
            <button
              class="px-6 py-3 text-[14px] font-Montserrat-Bold bg-black text-white rounded-[25px] hover:bg-gray-800 transition"
            >
              Edit
            </button>
            <button
              class="px-6 py-3 text-[14px] font-Montserrat-Bold bg-red-500 text-white rounded-[25px] hover:bg-red-600 transition"
            >
              Delete
            </button>
          </div>
      ...
      <!-- Account Info Form -->
      <div class="md:mt-12">
        <h2 class="text-[16px] md:text-[20px] font-semibold mb-3 md:mb-6">
          Account Info
        </h2>
        <div
          class="flex flex-wrap lg:grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6"
        >
          <!-- First Name -->
          ...
          <h2 class="text-[16px] md:text-[20px] font-semibold mt-3 md:hidden">
            Email
          </h2>
          <div class="flex flex-col gap-1 w-full md:w-[72%] lg:w-auto">
            <label
          ...
          <div
            class="flex flex-col md:flex-row gap-4 md:col-span-2 mt-[10px] justify-end lg:pt-[5rem] w-full md:w-[92%] lg:w-auto"
          >
            <button
        ...
        <div class="md:hidden pb-6">
          ...
          <div class="flex items-center">
            <img
              ...
              alt=""
              class="w-[76px] h-[76px] rounded-[10px] mr-3"
            />
            <img
              src="/Images/Profile/Avatar-2.png"
              alt=""
            ...
            />
            <div
              class="w-[76px] h-[76px] rounded-[10px] mr-3 border border-[#F3F3F3] flex items-center justify-center"
            >
              <svg
                width="20"
                height="21"
              ...
              >
                ...
                <path
                  d="M9.99997 7.5V13.5"
                  stroke="#FCFCFC"
                  stroke-width="0.824726"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M12.9999 10.5L6.99994 10.5"
                  stroke="#FCFCFC"
                  stroke-width="0.824726"
                  stroke-linecap="round"
                  stroke-linejoin="round"
  ...
  methods: {
    ...
    async updateProfile() {
      try {
        ...
        this.$toast.open({
          message: this.$i18n.t("profileUpdateOKMessage"),
        });
      } catch (error) {
        console.log(error);
