<template>
  <div class="w-full md:max-w-[35rem] space-y-8 md:w-[90%] md:p-8">
    ...
    <!-- <div>
        ...
        <div class="space-y-7">
            <div class="">
                <input class="styled-checkbox" id="emailNotif" type="checkbox" value="value1">
                <label for="emailNotif" class="font-bold text-[12px] md:text-[18px] text-[#121212]">Email Notification</label>
                <p class="pl-[25px] md:pl-[30px] text-[12px] md:text-[16px] text-[#121212] md:pt-2">You will be Email when a new notification arrives.</p>
            </div>
            <div class="">
                <input class="styled-checkbox" id="soundNotif" type="checkbox" value="value1">
                <label for="soundNotif" class="font-bold text-[12px] md:text-[18px] text-[#121212]">Sound Notification</label>
    ...
    <div>
      ...
      <div class="space-y-4 w-full md:max-w-[20rem]">
        ...
        <div class="relative">
          ...
          <p class="text-[12px] text-[#121212] mt-1">
            Minimum 8 characters with at least one uppercase, one special
...
@media screen and (max-width: 767px) {
  .styled-checkbox + label[data-v-717dfec5]:before {
    content: "";
    margin-right: 10px;
    display: inline-block;
    vertical-align: text-top;
