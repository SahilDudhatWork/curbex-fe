    ...
    <div class="max-w-3xl md:p-8">
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 gap-2 md:gap-4">
          ...
          >
            <div
              class="flex flex-col gap-1 w-full md:w-[69%] md:max-w-[244px] lg:max-w-[100%] lg:w-auto"
            >
              <label
                class="hidden md:block font-medium text-[#121212] text-[18px]"
                >Province</label
          ...
          <button
            class="block md:hidden bg-[#121212] text-[#FCFCFC] text-[12px] p-[0.60rem] rounded-[6px]"
          >
            Mark On Map
          </button>
        </div>
      ...
      <!-- Action Buttons -->
      <div class="flex flex-col md:flex-row gap-4 md:col-span-2 mt-[10px] justify-end lg:pt-[5rem] w-full md:w-[89%] md:max-w-[244px] lg:max-w-[100%] lg:w-full pt-[2rem] pb-[2rem] md:pb-0">
