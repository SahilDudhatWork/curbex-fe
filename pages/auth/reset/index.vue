  ...
  <div class="container mx-auto flex flex-wrap py-0 md:py-[3rem] lg:py-[10rem]">
    ...
    >
      ...
      <div class="mb-3 relative">
        ...
        <p
          class="text-black mb-4 text-[12px] md:text-[12px] text-[#121212] font-Montserrat-Medium"
        >
    ...
    <div
      class="lg:max-w-[580px] w-[90%] md:w-full p-6 mx-auto order-1 lg:order-2 mb-[2rem] lg:h-[257px] md:h-[402px] h-[167px] rounded-[20px] bg-cover bg-no-repeat bg-[0%_70%]"
      style="background-image: url('/Images/auth/new-password.png')"
    ></div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    console.log("mounted", this.$route.query.code);
  },
};
</script>
