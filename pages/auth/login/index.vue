<template>
  <div class="container mx-auto flex flex-wrap min-h-screen py-0 md:py-[3rem] lg:py-[10rem]">
    <div class="flex-1 lg:max-w-[640px] p-6 mx-auto lg:p-10 pt-0 bg-white order-2 lg:order-1">
      <h1 class="mb-2 text-[24px] md:text-[25px] text-[#121212] font-Montserrat-Medium font-bold pb-[2px]">Login</h1>
      <p class="inline-block text-black mb-6 text-[12px] md:text-[16px] text-[#121212] font-Montserrat-Medium">
      ...
      <div class="mb-4 relative">
        ...
        <NuxtLink to="/auth/register" class="underline inline-block text-black mb-4 text-[12px] md:text-[16px] text-[#121212] font-Montserrat-Medium">
          Forgot your password?
        </NuxtLink>
     

      <div class="flex items-center gap-2 mb-4 text-[12px] md:text-[16px] text-[#121212] font-bold py-2">
    ...
    <div class="lg:max-w-[640px] w-full p-6 mx-auto order-1 lg:order-2 md:mb-[4rem]">
      <!-- Image will be handled via background image -->
       <img src="/Images/auth/login.png" alt="login" class="w-full object-cover lg:h-auto md:h-[478px] h-[308px] rounded-[20px]">
    </div>
  </div>
</template>
