<template>
    <div class="container mx-auto flex flex-wrap min-h-screen py-0 md:py-[3rem] lg:py-[5rem]">
      <div class="flex-1 lg:max-w-[640px] p-6 mx-auto lg:p-10 pt-0 bg-white order-2 lg:order-1 lg:pt-[1rem]">
        <h1 class="mb-2 text-[24px] md:text-[25px] text-[#121212] font-Montserrat-Medium font-bold pb-[2px]">Register</h1>
        <h1 class="text-[16px] mb-2 md:text-[20px] text-[#121212] font-Montserrat-Medium md:font-bold pb-[2px]">Sign up with</h1>
        ...
        <h1 class="text-[16px] mb-2 md:text-[20px] text-[#121212] font-Montserrat-Medium md:font-bold py-[10px]">OR</h1>

        <h1 class="text-[16px] mb-2 md:text-[20px] text-[#121212] font-Montserrat-Medium md:font-bold pb-[2px]">Your Name</h1>
        <div class="mb-4">
          <input 
            type="text" 
            v-model="name" 
        ...
        <h1 class="text-[16px] mb-2 md:text-[20px] text-[#121212] font-Montserrat-Medium md:font-bold pb-[2px]">Business Name</h1>
        <div class="mb-4">
          <input 
            type="text" 
        ...
        <h1 class="text-[16px] mb-2 md:text-[20px] text-[#121212] font-Montserrat-Medium md:font-bold pb-[2px]">Login Details</h1>
        <div class="mb-4">
          <input 
            type="email" 
            v-model="email" 
        ...
        <div class="flex items-center gap-2 mb-1 text-[12px] md:text-[14px] lg:text-[16px] md:font-bold lg:font-normal text-[#121212] py-2">
        ...
        <div class="flex items-center gap-2 mb-6 text-[12px] md:text-[14px] lg:text-[16px] md:font-bold lg:font-normal text-[#121212] py-2">
          ...
          <label for="keepLoggedIn">Keep me logged in - applies to all log in options below.
            <NuxtLink to="/more-info" class="text-black underline">More info</NuxtLink>
          </label>
        </div>
  
        <button class="w-full p-3 px-5 bg-black hover:bg-[#8D54FF] text-white rounded-lg text-[12px] md:text-base cursor-pointer flex items-center justify-between gap-2">
            Register
      ...
      <div class="lg:max-w-[640px] w-full p-6 mx-auto order-1 lg:order-2 md:mb-[4rem]">
        <!-- Image will be handled via background image -->
         <img src="/Images/auth/register.png" alt="register" class="w-full lg:h-auto md:h-[478px] h-[308px] object-cover rounded-[20px]">
      </div>
    </div>
  </template>
