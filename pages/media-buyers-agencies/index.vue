    ...
    >
      ...
      <div class="container mx-auto">
        ...
        <div class="flex justify-center mt-10">
          ...
          >
            We understand that modern campaigns require multi-channel strategies
            to make an impact. Our high-impact mini billboards are the perfect
            way to complement digital, TV, and radio channels – offering
            nationwide visibility at a fraction of the cost of traditional
            billboards. Whether you’re driving foot traffic to stores, promoting
            brand awareness, or launching new products, Curbex signage provides
            the flexibility and impact your campaigns need to shine.
          </p>
        </div>
        ...
        <div>
          <div class="mt-10 lg:grid md:grid grid-cols-2 gap-8">
            <img
              src="/Images/media-buyers-agencies/2.png"
              alt=""
              class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]"
            />
            <img
              src="/Images/media-buyers-agencies/3.png"
              alt=""
              class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]"
            />
          </div>
      ...
      <div class="mt-8 md:mt-16">
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            >
              Big Impact for Big Brands on Any Budget
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]"
          >
            Our signage solutions offer the same high-quality visibility trusted
            by top brands, without the price tag of traditional billboards.
            Curbex mini billboards allow agencies and media buyers to achieve
            maximum reach across multiple locations – from local communities to
            nationwide campaigns – all while staying within budget.
            <span class="font-semibold"
              >Deliver your clients high-impact exposure without high
              costs.</span
            >
          </div>
        </div>
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            <p
              class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]"
            >
              Bring Your Brand to Life with Modern Visuals
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313]"
          >
            We place signs exactly where they matter most – right at or near the
            point of purchase. Unlike traditional billboards that may be 50+
            kilometers away from where a product or service is offered, Curbex
            signage is positioned where it will have the most influence. When
            your signs are placed directly at the business location or nearby,
            you can capture customers at the moment they are ready to act.
            <span class="font-semibold">
              Proximity matters: signage at the point of purchase drives real
              results.</span
            >
          </div>
        </div>
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            <p
              class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]"
            >
              Seamless Multi-Channel Campaign Integration
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313]"
          >
            Curbex signage is an ideal way to extend the impact of other media
            channels. Complement your digital, TV, or radio campaigns with
            highly visible, on-the-ground signage that reinforces messaging
            where people live, shop, and work. Our mini billboards ensure your
            message stays top of mind throughout the customer journey – from
            awareness to purchase.
            <span class="font-semibold">
              Amplify other media with bold, effective signage right where it
              counts.</span
            >
          </div>
        </div>
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            <p
              class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]"
            >
              Scalable Campaigns That Fit Every Client’s Needs
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313]"
          >
            From small local activations to national brand rollouts, Curbex
            signage scales effortlessly to meet the demands of your campaign.
            Whether you need signs in one neighborhood or dozens of locations
            across multiple cities, we provide the same high quality, ensuring
            consistency and professionalism throughout.
            <span class="font-semibold">
              Adaptable, scalable solutions to match your campaign goals.</span
            >
          </div>
        </div>
      </div>
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            <p
              class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]"
            >
              Seamless Execution and End-to-End Support
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]"
          >
            We make signage simple so you can focus on your clients. Our
            full-service model covers everything – from design to installation –
            ensuring flawless execution. Our expert team manages the logistics,
            so you don’t have to. Let us handle the details while you
            concentrate on strategy and client satisfaction.
          </div>
        </div>
      </div>
      <div class="mt-8 md:mt-8">
        ...
        >
          <div class="flex items-center gap-4 pb-5">
            ...
            <p
              class="font-semibold text-[16px] font-Montserrat-Medium md:text-[22px] text-[#000000]"
            >
              Proven ROI That Your Clients Will Love Our signage doesn’t just
              look good – it works.
            </p>
          </div>
          <div
            class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]"
          >
            Curbex signs generate measurable results by driving traffic, raising
            brand awareness, and creating engagement at critical touchpoints.
            With bold, eye-catching visuals placed right where the audience is,
            our signs deliver the return on investment that clients demand.
            <br />
            When signs are placed close to purchase points, they drive results
            traditional billboards can’t match.
          </div>
        </div>
      </div>
      <div class="mt-8 md:mt-8">
        ...
        >
          ...
          <div class="lg:flex items-center gap-3 mt-4">
            ...
            <span
              ...
              >Spark interest with strategic, localized signage.</span
            >
          </div>
          <div class="lg:flex items-center gap-3 mt-4">
            <p
            ...
            <span
              class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]"
              >Strengthen your client’s brand presence across multiple
              markets.</span
            >
          </div>
          <div class="lg:flex items-center gap-3 mt-4">
            ...
            <span
              class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]"
              >Roll out consistent messaging across regions with ease.</span
            >
          </div>
          <div class="lg:flex items-center gap-3 mt-4">
            <p
            ...
            <span
              class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]"
              >Get quick-turnaround signage for timely sales and events.</span
            >
          </div>
          <div class="lg:flex items-center gap-3 mt-4">
            <p
            ...
            <span
              class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]"
              >Showcase brand sponsorships at festivals, expos, and community
              events.</span
            >
          </div>
        </div>
            ...
            <div class="flex flex-wrap lg:gap-6 lg:gap-x-7">
              <div class="flex mb-7 md:mb-10 lg:mb-7 lg:w-[48%]">
                ...
                <div class="ml-[-20px]">
                  ...
                  <p class="text-[#000000] font-normal text-[15px] mt-2">
                    Nationwide visibility at a fraction of the cost of
              ...
              <div class="flex mb-7 md:mb-10 lg:mb-7 lg:w-[48%]">
                ...
                <div class="ml-[-20px]">
                  ...
                  <p class="text-[#000000] font-normal text-[15px] mt-2">
                    Seamlessly complement other advertising channels.
                  </p>
                </div>
              </div>
              <div class="flex mb-7 md:mb-10 lg:mb-7 lg:w-[48%]">
                ...
                <div class="ml-[-20px]">
                  ...
                  <p class="text-[#000000] font-normal text-[15px] mt-2">
                    Signs placed at or near the business for greater
                    effectiveness.
                  </p>
                </div>
              </div>
              <div class="flex mb-7 md:mb-10 lg:mb-7 lg:w-[48%]">
                ...
                <div class="ml-[-20px]">
                  ...
                  <p class="text-[#000000] font-normal text-[15px] mt-2">
                    From design to installation, we manage the entire process.
                  </p>
                </div>
              </div>
              <div class="flex mb-7 md:mb-10 lg:mb-7 lg:w-[48%]">
                ...
                <div class="ml-[-20px]">
                  ...
                  <p class="text-[#000000] font-normal text-[15px] mt-2">
                    ROI-driven campaigns that exceed client expectations.
                  </p>
                </div>
              </div>
            </div>
    ...
    <div class="mt-20 bg-[#121212]">
      <div class="container mx-auto mt-[1.5rem] md:mt-10">
        <p class="text-[#FFFFFF] font-bold p-[2rem] text-[28px]">
          ...
          value.
          <br /><br />
          With signs strategically placed where they make the biggest impact, we
          help you deliver campaigns that exceed expectations – and stay within
          budget.
        </p>
      </div>
    </div>
    ...
    <div class="container mx-auto mt-10 md:mt-20 mb-[5rem] px-6 md:px-0">
      ...
      <div id="accordion-color" data-accordion="collapse">
        ...
        >
          ...
          >
            <p class="text-gray-500 dark:text-gray-400">
              Yes! Our signage solutions can be deployed across Canada, offering
              a consistent, high-quality presence nationwide.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            <p class="text-gray-500 dark:text-gray-400">
              Our signs are perfect for reinforcing messages from digital, TV,
              and radio campaigns, ensuring your clients’ brands stay top of
              mind.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            <p class="text-gray-500 dark:text-gray-400">
              ...
              maximizes impact by reaching customers right when they’re ready to
              act.
            </p>
          </div>
        </div>
