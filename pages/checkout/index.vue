    ...
    <div class="container mx-auto py-[3rem] px-6 lg:px-0">
      <div class="flex justify-between flex-wrap lg:flex-nowrap">
        <div class="w-full lg:w-[48%]">
          ...
          <div class="max-h-[323px] pr-3 overflow-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
            <div class="mb-3 address-tab-Active address-tab">
              <div class="flex items-center flex-wrap">
                <div class="radio-section bg-[#E3E3E3] text-[#121212] flex items-center w-fit p-[10px_20px] rounded-[60px_0px_0px_60px] border border-[#E3E3E3]">
                  <span class="w-[13px] h-[13px] bg-[#FFFFFF] block rounded-[30px] mr-[10px]"></span>
                  <p class="text-[14px]"> Vancouver </p>
                </div>
                <div class="address-details bg-[#FFFFFF] text-[#C3C3C3] flex item-center justify-between w-[75%] p-[15px] rounded-[0px_60px_60px_0px] border border-[#E3E3E3]">
                  <div class="flex items-center">
                    ...
                    <p class="p-[0px_10px] text-[14px]">
                      789 Westwood Avenue, Vancouver, BC V6B 1A1 
                    </p>
                  </div>
                  <span>
          ...
          <div class="flex items-center m-[15px_0px_25px] cursor-pointer">
            <span class="block mr-3">
              <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="1.375" y="0.75" width="22.5" height="21.5" rx="10.75" fill="#F5F5F5" stroke="#121212" stroke-width="1.5"/>
                <path d="M12.918 7.49023V16.6553" stroke="#121212" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M8.70898 11.8027L17.6555 11.8027" stroke="#121212" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
            </span>
