<template>
    <div>
        <div class="container mx-auto px-6 md:px-0">
            <div class="flex flex-wrap lg:flex-nowrap">
                <div class="w-full lg:w-[50%] lg:mr-[4rem] mb-[35px] border border-[#F5F5F5] rounded-[20px] p-[0.25rem] md:p-5">
                    <div class="overflow-hidden rounded-[8px] relative">
                        ...
                        <div class="absolute top-[15px] right-[15px]">
                            <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" class="border border-[#F3F3F3] p-[0.425rem] md:p-2.5 block w-[33px] md:w-[45px] h-[33px] md:h-[45px] rounded-full bg-[#FCFCFC] mb-3">
                            ...
                            <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="border border-[#F3F3F3] p-[0.425rem] md:p-2.5 block w-[33px] md:w-[45px] h-[33px] md:h-[45px] rounded-full bg-[#FCFCFC] mb-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex justify-between mt-[20px] w-full md:w-[85%] px-6 md:px-0 mb-2 md:mb-0">
                            <img src="/Images/Product/new.png" alt="" class="w-[68px] md:w-[122px] h-[68px] md:h-[122px] object-contain border border-[#F5F5F5] rounded-[12px] mr-[5px]" >
                            <img src="/Images/Product/new.png" alt="" class="w-[68px] md:w-[122px] h-[68px] md:h-[122px] object-contain border border-[#F5F5F5] rounded-[12px] mr-[5px]" >
                            <img src="/Images/Product/new.png" alt="" class="w-[68px] md:w-[122px] h-[68px] md:h-[122px] object-contain border border-[#F5F5F5] rounded-[12px] mr-[5px]" >
                            <img src="/Images/Product/new.png" alt="" class="w-[68px] md:w-[122px] h-[68px] md:h-[122px] object-contain border border-[#F5F5F5] rounded-[12px] mr-[5px]" >
                        </div>
                ...
                <div class="w-[100%] lg:w-[50%] lg:pl-[2rem]">
                    <div class="w-full md:w-[72%] lg:w-full">
                        <h3 class="text-[#000000] text-[20px] md:text-[30px] font-Montserrat-Bold pb-[10px]">Downtowner <span class="bg-[#FFEBC3] rounded-[5px] text-[#121212] text-[14px] font-normal font-Montserrat-Medium p-[2px_8px]">Retail</span></h3>
                        <p class="text-[#000000] text-[18px] md:text-[25px] font-Montserrat-Medium pb-[20px]">$209 <span class="text-[#A0A0A0] ml-2 line-through">$250</span> <span class="ml-3 bg-[#29CC6A] rounded-[5px] text-[#FFFFFF] text-[14px] font-normal font-Montserrat-Medium p-[2px_8px]">Save 18%</span></p>
                        <div class="border-t border-b border-[#D5D5D5] p-[10px_0px]">
                            <p class="text-[14px] md:text-[16px] text-[#121212] font-Montserrat-Medium mb-[5px]">Setup Fee: $59</p>
                            <p class="text-[14px] md:text-[16px] text-[#121212] font-Montserrat-Medium mb-[5px]">Ad design Fee: $10</p>
                        ...
                        <div class="flex py-[20px] border-b border-[#D5D5D5] flex-wrap">
                            <div class="flex items-center m-[5px] md:m-0 md:mr-5 border md:border-0 md:border-r border-[#F5F5F5] md:border-[#121212] min-w-[150px] rounded-[5px] md:rounded-[0px] p-[10px] md:p-0 md:pr-8">
                                <div class="mr-2">
                    ...
                    <div class="flex flex-wrap justify-between border-b border-[#D5D5D5] mb-5">
                        <button class="bg-[#FFA900] text-[16px] md:text-[18px] text-center py-[11px] rounded-[7px] w-full md:w-[49%] font-Montserrat-Medium mb-[20px]">Add to cart</button>
                        <button  @click="showDesignModal = true" class="bg-[#121212] text-[16px] md:text-[18px] text-white border-[1px] border-[#000000] w-full md:w-[49%] rounded-[7px] py-[11px] mb-[20px]">Select Design Method</button>
                    ...
                    <div class="flex flex-wrap">
                        <div class=" flex items-center w-[47%] md:w-[30%] md:mr-5 border md:border-0 border-[#F5F5F5] p-2 md:p-0 m-[5px] md:m-0 rounded-[9px]">
                            ...
                            <div class="text-[12px]">
                                <p class="text-[#121212] text-[12px] md:text-[14px] font-Montserrat-Bold pb-1">Free Delivery</p>
                                <p class="text-[#121212] text-[10px] md:text-[12px] font-Montserrat-Bold">1-2 day </p>
                            </div>
                        </div>
                        <div class=" flex items-center w-[47%] md:w-[30%] md:mr-5 border md:border-0 border-[#F5F5F5] p-2 md:p-0 m-[5px] md:m-0 rounded-[9px]">
                            <div class="bg-[#DAC8FF] md:bg-[#F4F4F4] rounded-[6px] p-3 mr-3">
                            ...
                            <div class="text-[12px]">
                                <p class="text-[#121212] text-[12px] md:text-[14px] font-Montserrat-Bold pb-1">In Stock</p>
                                <p class="text-[#121212] text-[10px] md:text-[12px] font-Montserrat-Bold">Today</p>
                            </div>
                        </div>
                        <div class=" flex items-center w-[47%] md:w-[30%] md:mr-5 border md:border-0 border-[#F5F5F5] p-2 md:p-0 m-[5px] md:m-0 rounded-[9px]">
                            <div class="bg-[#DAC8FF] md:bg-[#F4F4F4] rounded-[6px] p-3 mr-3">
                            ...
                            <div class="text-[12px]">
                                <p class="text-[#121212] text-[12px] md:text-[14px] font-Montserrat-Bold pb-1">Guaranteed</p>
                                <p class="text-[#121212] text-[10px] md:text-[12px] font-Montserrat-Bold">30 Day</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-6 md:px-0">
            <div class="flex flex-wrap lg:flex-nowrap pt-[50px]">
                <div class="w-full lg:w-[50%] order-2 lg:order-1 pb-[4rem] lg:pb-0"> 
                    <p class="w-fit bg-[#FFA900] text-[#121212] font-Montserrat-Medium font-semibold text-[18px] md:text-[20px] rounded-full py-[8px] px-6 mb-[25px]">FAQ</p>
                ...
                <div class="w-full lg:w-[50%] order-1 lg:order-2 mb-[3rem] lg:mb-0">
                    <img src="/Images/Product/5.jpg" alt="" class="w-full lg:w-[80%] md:h-[354px] lg:h-auto mx-auto object-cover rounded-[28px]">
                </div>
            </div>
        </div>
        <div class="container mx-auto px-6 md:px-0">
            <!-- <p class="text-[30px] text-[#000000] font-Montserrat-Medium font-bold pt-[5rem] pb-[2rem]">You might also like</p> -->
            <p class="w-fit bg-[#FFA900] text-[#121212] font-Montserrat-Medium font-semibold text-[18px] md:text-[20px] rounded-full py-[8px] px-6 mb-[25px]">You might also like</p>
            <CarouselSlider/>
        </div>
        <div class="container mx-auto px-6 md:px-0">
            <!-- <p class="text-[30px] text-[#000000] font-Montserrat-Medium font-bold  pb-[2rem]">Downtowner in practice</p> -->
            <p class="w-fit bg-[#FFA900] text-[#121212] font-Montserrat-Medium font-semibold text-[18px] md:text-[20px] rounded-full py-[8px] mt-[3rem] lg:mt-[5rem] px-6 mb-[25px]">Downtowner in practice</p>
            <Carousel :perPageCustom="perPageCustom" :autoplay="true" :autoplayTimeout="3000" loop :nav="false" :dots="false">
        ...
        <div class="container mx-auto px-6 md:px-0 pb-[4rem]">
            ...
            <p class="w-fit bg-[#FFA900] text-[#121212] font-Montserrat-Medium font-semibold text-[18px] md:text-[20px] rounded-full py-[8px] mt-[5rem] px-6 mb-[25px]">From our costumers</p>
            <Testimonial :testiminoalSlider="testiminoalSlider"/>
        </div>
        <div class="bg-[#FCFCFC]">
            <div class="container mx-auto px-6 md:px-0 py-5">
                <p class="w-fit bg-[#FFA900] text-[#121212] font-Montserrat-Medium font-semibold text-[18px] md:text-[20px] rounded-full py-[8px] mt-[1.5rem] px-6 mb-[25px]">Order now</p>
                <form action="">
                    <p class="text-[16px] font-Montserrat-Medium mb-4">Have you rented from Curbex before?</p>
                    <div class="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 pt-[4rem]">
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">First Name
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="Ryan" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Last Name
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="Reynolds" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Business Name
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="Hello" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Phone Number
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="tel" placeholder="555 555 5555" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Email
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="email" placeholder="Ryan@gmail.com" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        <div class="md:hidden lg:block"></div>
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Landlord/Property Owner Name
                                <!-- <span class="text-[#FF0000]">*</span> -->
                            </label>
                            <input type="text" placeholder="Blake Lively" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 pt-[2rem]">
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">When do you need a sign?
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="10/Feb/2025" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Rental Duration
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="3 weeks" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                    </div>
                    <p class="text-[20px] font-Montserrat-Medium mb-4 pt-[2rem]">Your Business Address</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 pt-[1rem]">
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Address Line 1
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="123 Maplewood Lane" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>

                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Unit Number
                                <!-- <span class="text-[#FF0000]">*</span> -->
                            </label>
                            <input type="text" placeholder="123 Maplewood Lane" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        ...
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">City
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="Toronto" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Province
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="ON" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Postal Code
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="M4B 1B3" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        <div class="relative">
                            <label class="text-[#000000] text-[14px] md:text-[16px] font-Montserrat-Medium">Country
                                <span class="text-[#FF0000]">*</span>
                            </label>
                            <input type="text" placeholder="Canada" class="w-full mt-2 px-4 py-[0.49rem] md:py-[0.69rem] border border-[#121212] bg-[transparent] rounded-[8px] focus:outline-none focus:border-[#000000]">
                        </div>
                        <label class="flex items-center cursor-pointer w-full md:min-w-[440px]">
                            <input type="radio" name="rental_history" value="no" class="hidden"v-model="rentalHistory">
                            <span class="w-5 h-5 border-2 border-black rounded-sm flex items-center justify-center mr-2">
                                <svg class="w-3 h-3" v-show="rentalHistory === 'no'" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 4L4.5 7.5L11 1" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="text-[12px] md:text-[16px] text-[#121212]">I have read and agree to the <a href="#" class="text-[#000000] underline">Terms and Conditions</a>
                            </span>
                        </label>
                    </div>
                    <button class="mt-[2rem] w-full bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-[16px] md:text-lg font-medium py-[0.65rem] rounded-[6px] transition duration-200 ease-in-out shadow-lg hover:shadow-xl">
  Submit Order Request
        ...
        <DesignMethod
            ...
            @logoutConfirmed="handleDesign"
            @logoutCancelled="showDesignModal = false"
        />
    </div>
</template>
<script>
