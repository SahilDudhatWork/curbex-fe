    ...
    <div>
        ...
        <div class="container mx-auto">
            <div class="flex pt-[50px]">
                ...
                <div class="w-[50%]">
                    <img src="/Images/Product/5.png" alt="" class="w-[80%] mx-auto">
                </div>
            </div>
        </div>
        <div class="container mx-auto">
        ...
        <div class="container mx-auto">
            ...
            <Carousel :perPage="4" :autoplay="true" :autoplayTimeout="3000" loop :nav="false" :dots="false">
                <Slide class="relative m-2">
                    <div class="relative">
                        <img src="/Images/Product/6.png" alt="" class="">
                    </div>
                </Slide>
                <Slide class="relative m-2">
                    <div class="relative">
        ...
        <div class="bg-[#FCFCFC]">
            <div class="container mx-auto py-5">
                <p class="text-[30px] text-[#000000] font-Montserrat-Medium font-bold pt-[4rem] pb-[2rem]">Order now</p>
                <form action="">
                    <p class="text-[18px] font-Montserrat-Medium mb-4">Have you rented from Curbex before?</p>
                    <div class="">
                        <label class="flex items-center cursor-pointer mb-[1rem]">
                            <input type="radio" name="rental_history" value="yes" class="hidden" v-model="rentalHistory">
                            <span class="w-5 h-5 border-2 border-black rounded-sm flex items-center justify-center mr-2">
                                <svg class="w-3 h-3" v-show="rentalHistory === 'yes'" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 4L4.5 7.5L11 1" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
                        ...
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="w-5 h-5 border-2 border-black rounded-sm flex items-center justify-center mr-2">
                                <svg class="w-3 h-3" v-show="rentalHistory === 'no'" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 4L4.5 7.5L11 1" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
                    ...
                    <div class="grid grid-cols-3 gap-8 pt-[4rem]">
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-3 gap-8 pt-[1rem]">
                        ...
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="text-[16px] text-[#121212]">I have read and agree to the <a href="#" class="text-[#000000] underline">Terms and Conditions</a>
                            </span>
                        </label>
                    </div>
                    <button class="mt-[2rem] w-full bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-lg font-medium py-4 rounded-xl transition duration-200 ease-in-out shadow-lg hover:shadow-xl">
    ...
    setup() {
        onMounted(() => {
            ...
            accordionElements.forEach((accordion) => {
                ...
                import('flowbite').then(({ default: Flowbite }) => new Flowbite(accordion));
            });
        });
    },
};
