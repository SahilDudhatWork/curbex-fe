  ...
  <div class="max-w-[995px] mx-auto mb-[2rem]">
    <div class="flex justify-between flex-wrap md:flex-nowrap">
      ...
      <div class="w-full md:w-[60%] pb-[2rem] md:pb-[4rem]">
        ...
        <div
          class="bg-[#FCFCFC] border border-[#F5F5F5] rounded-[25px] p-[15px] flex justify-between flex-wrap lg:flex-nowrap"
        >
          <div
            @click="isArtWorkNow = true"
            class="bg-[#FFFFFF] border border-[#C3C3C3] p-[15px] rounded-[13px] text-center hover:border-[#8D54FF] w-[100%] mb-5 lg:w-[49%] lg:mb-0"
          ...
          >
            <div class="flex justify-center">
              ...
              >
                ...
                />
                <path
                  d="M13.0997 19.6888L18.2553 14.5332L23.4108 19.6888"
                  stroke="#121212"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <button
              @click="uploadArtwork"
              class="bg-[#121212] text-[12px] text-[#FFFFFF] rounded-[57px] p-[6px_15px]"
            >
              Browse files
            </button>
          </div>
          <div
            @click="isArtWorkNow = false"
            class="bg-[#FFFFFF] border border-[#C3C3C3] p-[15px] rounded-[13px] text-center hover:border-[#8D54FF] w-[100%] lg:w-[49%]"
            :class="!isArtWorkNow ? 'section-active' : ''"
          >
            <div class="flex justify-center">
              <svg
              ...
              >
                <path
                  d="M15.5 28.9284C23.1926 28.9284 29.4286 22.6924 29.4286 14.9999C29.4286 7.30732 23.1926 1.07129 15.5 1.07129C7.80748 1.07129 1.57144 7.30732 1.57144 14.9999C1.57144 22.6924 7.80748 28.9284 15.5 28.9284Z"
                  stroke="#121212"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                />
                <path
                  d="M15.5 9.64258V14.9997L20.9429 21.3426"
                  stroke="#121212"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <p class="text-[9px] text-left mx-auto max-w-[190px]">
              You can proceed by placing your order, and we’ll email you a link
              to upload your artwork files.
            </p>
          </div>
        </div>
        <p class="border-b border-[#F5F5F5] my-4"></p>
  ...
  methods: {
    ...
    async productAddToCart() {
      try {
        ...
        if (cartData?.id) {
          if (this.isArtWorkNow) {
            await this.uploadArtworkToCart(cartData.id, cartData.quantity);
          } else {
          ...
          if (this.isArtWorkNow) {
            ...
            if (newCartData?.id) {
              await this.uploadArtworkToCart(
                newCartData.id,
    ...
    async uploadArtworkToCart(cartItemId, quantity) {
      if (this.notes == "") {
      ...
      formData.append("requestedDesigner", 0);
