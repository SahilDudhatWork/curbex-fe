    ...
    <div>
      <div class="mx-6">
          ...
          <div class="container mx-auto mb-[3rem] md:mb-[6rem]">
              <div class="pt-5">
                  <img src="/Images/small-business-franchise/1.png" alt="" class="rounded-[20px] h-[206px] md:h-[461px] object-cover w-full">
              </div>
          </div>
      </div>
      <!------------------------------------------------->
      ...
      <!--------------------- Government & Non-Profit ---------------------->
          <div class="container mx-auto">
              <div class="flex justify-center">
                  <h1 class="text-[15px] sm:text-[30px] lg:text-[38px] text-white font-Montserrat-Bold bg-[#121212] py-[6px] px-8 rounded-full mt-[-51px] mb-[15px] sm:mt-[-63px] sm:mb-[8px] lg:mt-[-65px] lg:mb-[3px]">Small Business & Franchise </h1>
              </div>
              <div class="flex justify-center mt-4 md:mt-10">
                  <p class="text-[#000000] font-semibold text-[18px] font-Montserrat-Medium md:text-[23px] md:max-w-[600px] lg:max-w-full lg:text-[33px] text-center">Affordable Signage Solutions for Small Businesses</p>
              </div>
          ...
          <div class="container mx-auto">
              ...
              <div class="flex justify-center mt-10">
                  <p class="max-w-screen-xl mx-auto text-[#131313] font-normal text-[16px] md:text-[21px] text-left lg:text-center pb-5 leading-[31px]">At Curbex, we understand the unique challenges faced by small businesses, from tight budgets to fierce competition. That's why our mini billboards deliver high-impact, professional-quality signage at a fraction of the cost. Whether you're launching a new business, promoting a sale, or increasing brand awareness, Curbex offers a solution that brings your vision to life with modern, affordable, and customizable signs.</p>
              </div>
      
              <div>
                  <div class="mt-10 lg:grid md:grid grid-cols-2 gap-8">
                      <img src="/Images/small-business-franchise/2.png" alt="" class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]">
                      <img src="/Images/small-business-franchise/3.png" alt="" class="w-full mb-5 md:h-[305px] h-[206px] lg:h-[305px] object-cover rounded-[20px]">
                  </div>
              </div>  
          </div>
          <!------------------------------------------------->
          ...
          <div class="mt-8 md:mt-16">
              <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                  <div class="flex items-center gap-4 pb-5">
                      ...
                      <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[24px] text-[#000000]">Big Brand Impact on a Small Business Budget</p>
                  </div>
                  <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    You don’t have to compromise between quality and affordability. Our signage solutions offer the same professional designs and durability trusted by large corporations, tailored for small business needs. With flexible pricing options, you can access high-impact advertising without breaking the bank. <span class="font-semibold"> Our Guarantee: Eye-catching signs that captivate your audience and elevate your brand just like the big players.</span>
                  </div>
              </div>
          </div>
          <div class="mt-8 md:mt-14">
              <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                  <div class="flex items-center gap-4 pb-5">
                      ...
                      <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[24px] text-[#000000]">Bring Your Brand to Life with Modern Visuals</p>
                  </div>
                  <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    In a crowded market, standing out is essential. Our modern signage options ensure your business is always at the forefront with vibrant, professional designs that reflect your brand’s identity. Whether you’re opening a new location, hosting an event, or running seasonal promotions, we provide creative displays that leave a lasting impression. <span class="font-semibold">   Boost your brand visibility and connect with customers through engaging, bold designs.</span>
                  </div>
              </div>
          </div>
          <div class="mt-8 md:mt-14">
              <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                  <div class="flex items-center gap-4 pb-5">
                      ...
                      <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[24px] text-[#000000]">Easy, Flexible, and Customizable Advertising</p>
                  </div>
                  <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313] leading-[31px]">
                    With Curbex, you don’t have to be a marketing expert to create effective ads. Our process is as easy as ordering your favorite meal – fast, intuitive, and available whenever you need it. From installation to design customization, we offer full support, allowing you to focus on your business while we handle the details. <br>
                    <span class="font-semibold">Your signs, your way: customizable sizes, colors, and formats to fit your needs.</span>
                  </div>
              </div>
          </div>
          <div class="mt-8 md:mt-14">
              <div class="border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                  <div class="flex items-center gap-4 pb-5">
                      ...
                      <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[24px] text-[#000000]">Measurable ROI for Every Campaign</p>
                  </div>
                  <div class="text-[16px] md:text-[18px] lg:text-[21px] font-normal text-[#131313]">
                    High-quality signage doesn’t just look good – it works. Curbex signs deliver exceptional return on investment (ROI) by driving foot traffic, enhancing brand recognition, and generating leads. Our clients see results because our signs grab attention where it matters most – right in front of your audience.
                  </div>
              </div>
          </div>
          <div class="mt-8 md:mt-14">
              <div class="group border-[2px] border-[#F3F3F3] rounded-[21px] px-4 sm:px-7 py-6 hover:border-[#8D54FF]">
                  <div class="flex items-center gap-4 pb-5">
                      ...
                      <p class="font-semibold text-[16px] font-Montserrat-Medium md:text-[24px] text-[#000000]">Use Cases for Curbex Signage in Small Business</p>
                  </div>
                  <div class="lg:flex items-center gap-3 mt-4">
                      <p class="w-fit block text-[#121212] font-Montserrat-Medium font-semibold text-[16px] md:text-[18px] lg:text-[21px] bg-[#EAEAEA] group-hover:bg-[#D1BAFF] rounded-[34px] px-4 py-[5px]">Grand Openings</p>
                      <span class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]">Announce your new location with bold signage that invites the community in.</span>
                  </div>
                  <div class="lg:flex items-center gap-3 mt-4">
                      <p class="w-fit block text-[#121212] font-Montserrat-Medium font-semibold text-[16px] md:text-[18px] lg:text-[21px] bg-[#EAEAEA] group-hover:bg-[#D1BAFF] rounded-[34px] px-4 py-[5px]">Sales & Promotions</p>
                      <span class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]">Maximize sales with highly visible signs promoting limited-time offers.</span>
                  </div>
                  <div class="lg:flex items-center gap-3 mt-4">
                      <p class="w-fit block text-[#121212] font-Montserrat-Medium font-semibold text-[16px] md:text-[18px] lg:text-[21px] bg-[#EAEAEA] group-hover:bg-[#D1BAFF] rounded-[34px] px-4 py-[5px]">Event Advertising</p>
                      <span class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]">Promote events like community markets, sidewalk sales, or product launches.</span>
                  </div>
                  <div class="lg:flex items-center gap-3 mt-4">
                  ...
                  <div class="lg:flex items-center gap-3 mt-4">
                      <p class="w-fit block text-[#121212] font-Montserrat-Medium font-semibold text-[16px] md:text-[18px] lg:text-[21px] bg-[#EAEAEA] group-hover:bg-[#D1BAFF] rounded-[34px] px-4 py-[5px]">Seasonal Campaigns</p>
                      <span class="text-[#000000] font-normal text-[16px] md:text-[18px] lg:text-[21px]">Get festive with themed signs that align with holidays or seasonal sales.</span>
                  </div>
              </div>
          </div>
  
          <div class="mt-14">
              <img src="/Images/small-business-franchise/4.png" alt="" class="w-full h-[182px] md:h-[340px] lg:h-auto object-cover rounded-[20px]">
          </div>
  
          <div class="mt-20">
              <div class="flex">
                  <p class="bg-[#FFA900] text-[#121212] font-semibold text-[16px] sm:text-[18px] md:text-[24px] rounded-[17px] md:rounded-full py-[7px] px-6">
                    Join Small Businesses Across Canada Using Curbex Signs
                  </p>
              </div>
      ...
      <div class="flex justify-center mb-10 md:mb-20 container mx-auto">
          <div class="border-[4px] border-[#8D54FF] mt-10 md:mt-[7rem] md:mb-[1rem] p-[1rem] md:p-[3rem] md:p-[2rem] max-w-[986px] rounded-[22px] md:rounded-[73px] m-[20px] md:m-0">
              <p class="font-bold text-[30px] md:text-[50px] text-[#8D54FF] text-center font-Montserrat-Bold">Get Started with Curbex Today</p>
              <p class="text-[#000000] font-normal text-[16px] md:text-[26px] text-center py-[25px]">Give your small business the attention it deserves</p>
              <p class="text-[#000000] font-bold text-[16px] md:text-[26px] text-center">Order your signs today and see how Curbex can help you achieve big results with small business-friendly solutions.</p>
          </div>
      </div>
          ...
          <div id="accordion-color" data-accordion="collapse">
              ...
              <h2 id="accordion-color-heading-1" class="mb-2">
                  ...
                  :aria-expanded="activeAccordion === 1" @click="toggleAccordion(1)">
                      <span class="text-left font-bold font-Montserrat-Medium">How soon can I receive my signage?</span>
